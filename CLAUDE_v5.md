...
| 1b | EV-zone DXF rendering + ontwerp-workflow | ★★★★★ WETTELIJK | EV-waarschuwing handmatig |
| 2 | GWSW riool BOB + gemeente-mail auto | ★★★★ Martien | Handmatig mailen |
| 3 | Sleufloze leidingen detectie KLIC PDF | ★★★★ Martien | Handmatig uitzoeken |
| 4 | Conflictcheck K&L 3D afstand | KERN | Altijd WAARSCHUWING |
| 5 | Boorprofiel geometrie ARCs + tangentiaal | KERN | Handmatige hoeken |
| 6 | AHN5 maaiveld PDOK WCS | KERN | Handmatig MVin/MVuit |
| 7 | Tracévarianten vergelijken + PDF | ★★★★ Martien | Telefonisch overleg |
...
| 10 | Topotijdreis historische kaarten API | ★★★★ Martien | Handmatige controle |
| 11 | Vergunningscheck omgevingswet.overheid.nl | ★★★ Martien | Handmatig uitzoeken |
| 12 | Intrekkrachtberekening NEN 3651 (Sigma-transparant) | OPTIONEEL | Handmatig Sigma |
| 13 | Werkplan generator Claude API | ★★★★ Martien | ~2u schrijven |

Noten:
- Item 1b (EV-zone): wettelijk kritisch, direct na item 1 bouwen ongeacht klantvolgorde
- Item 10 (Topotijdreis): onderzoeken of API beschikbaar is; scope en tijdsbereik bepalen samen met Martien
- Item 11 (Vergunningscheck): eerst onderzoek naar omgevingswet.overheid.nl API mogelijkheden
- Item 12 (Berekeningen): onderzoeken of transparante output (zoals Sigma-uitdraai) volstaat als alternatief voor gecertificeerde software
...
| AI tekst | Anthropic Claude API (backlog 13) | Werkplan generator |
...
│       ├── calculations/   # LEEG → backlog 12
│       ├── documents/      # PDF + DXF generator
│       ├── ai_assist/      # LEEG → backlog 13
...
**Topotijdreis — historische kaarten (backlog 10).**
...
**Intrekkracht optioneel.** Alleen als opdrachtgever vraagt. Martien: "nice-to-have." Backlog positie 12.

**Sigma validatie — ontwerpconstraint backlog 12.**
...
kan als acceptabel alternatief worden beschouwd. Onderzoeken bij start backlog 12.
Deltares biedt ook een software tool aan als alternatief voor Sigma.

**Vergunningscheck omgevingswet.overheid.nl (backlog 11).**
...
ANTHROPIC_API_KEY=[indien backlog 13 actief]
```
